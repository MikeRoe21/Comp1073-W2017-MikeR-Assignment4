...
function Main():void {
    ...
    clickMeButton = new objects.Button("comp1073-a4-mikeroe.azurewebsites.net/Client-Side-Scripting-Assignment-4/Assets/Kirby.gif", true, 150, 40, canvasHalfWidth, canvasHalfHeight + 50);
